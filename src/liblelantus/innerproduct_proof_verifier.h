#ifndef BZX_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
#define BZX_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
...
#endif //BZX_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
