#ifndef BZX_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
#define BZX_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
...
#endif //BZX_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
