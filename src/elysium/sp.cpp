...
CMPSPInfo::CMPSPInfo(const boost::filesystem::path& path, bool fWipe)
{
    ...
    implied_elysium.url = "https://www.BZX.org";
    implied_elysium.data = "Exodus serve as the binding between BZX, smart properties and contracts created on the Exodus Layer.";
    ...
    implied_telysium.url = "https://www.BZX.org";
    implied_telysium.data = "Test Exodus serve as the binding between BZX, smart properties and contracts created on the Exodus Layer.";
        ...
        std::pair<int64_t, int64_t>& tokens, bool& close_crowdsale)
{
    ...
    // Precision for all non-BZX values (bonus percentages, for example)
    ...
    // Precision for BZX amounts (satoshi)
