...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    if (ui->radioSmartFee->isChecked())
    {
        ...
        ui->confirmationTargetLabel->setText(GUIUtil::formatDurationStr(nConfirmTarget * Params().GetConsensus().nPowTarget) + " / " + tr("%n block(s)", "", nConfirmTarget));
    }
    else
    {
...
void SendCoinsDialog::setAnonymizeMode(bool enableAnonymizeMode)
{
    ...
    if (fAnonymousMode) {
        ...
        ui->label->setText(QString(tr("Private Balance")));
        ...
        ui->label->setText(QString(tr("Transparent Balance")));
